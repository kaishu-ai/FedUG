    ...
    for i in range(args.comm + 1):
        for domain_name in dataobj.train_domain_list:
            ...
            site_results_before_avg[domain_name] = site_evaluation(i, domain_name, args, model_dict[domain_name],
                                                                   dataloader_dict[domain_name]['val'], log_file,
        ...
        site_evaluation(i, args.test_domain, args, model_dict[args.test_domain],
                        dataloader_dict[args.test_domain]['test'], log_file, log_ten, metric, note='test_domain')
